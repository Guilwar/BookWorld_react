...
function Navbar({ counterShop }) {
  const [isHamburgerOpen, setIsHamburgerOpen] = useState(null);
  ...
  return (
    <>
      <div className="navbar">
        ...
        <div className="navbarButton">
          ...
          <Link to="/search">
            <button className="navbarLogoSearch">
              ...
              <div className="navbarLogoInfoSearch">Cerca</div>
            </button>
          </Link>

          <Link to="/category">
            <button className="navbarLogoCategory">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        {!isHamburgerOpen && (
          <div className="hamburger-icon-navbar" onClick={OpenHamburger}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div
          className={`lateral-bar-navbar ${
            isHamburgerOpen == null ? "" : isHamburgerOpen ? "open" : "close"
          }`}
        >
          {isHamburgerOpen && (
            <div onClick={CloseHamburger}>
              ...
              <div className="side-bar-content">
                <Link to="/home">
                  <div className="container-sidebar-element">
                    <button className="navbarLogoHome">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                    ...
                    <div className="sidebar-div-icon">
                      <span className="sidebar-span-icon">Home</span>
                    </div>
                  </div>
                </Link>
                <Link to="/search">
                  <div className="container-sidebar-element">
                    ...
                    <div className="sidebar-div-icon">
                      <span className="sidebar-span-icon">Cerca</span>
                    </div>
                  </div>
                </Link>
                <Link to="/category">
                  <div className="container-sidebar-element">
                    ...
                    <div className="sidebar-div-icon">
                      <span className="sidebar-span-icon">Libreria</span>
                    </div>
                  </div>
                </Link>
                {/* <Link to="/shop">
